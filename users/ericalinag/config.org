...
My /ericalinag.h/ is really simple. It used to be everything.
It turns out to be really simple, because its just that someone, a combo, or
something else wants to know my layer names. Long ago, /ericalinag.h/ was the
...
#+begin_src C :tangle ericalinag.h
#pragma once
/*
  Copyright 2023 Erica Gebhart <Ericalinag@proton.me>
...
#+begin_src C :tangle ericalinag.c
/*
